        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-white font-serif mb-4">
              Active Development <span className="text-[#d4af37]">Opportunities</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            {filteredProjects.map((project) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#d4af37] hover:shadow-xl hover:shadow-[#d4af37]/10 hover:scale-[1.02]"
                >
                  {/* Image */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <div className="text-[#d4af37] font-bold">{project.targetAnnualReturn}% APY</div>
                      </div>
                      <div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-12 max-w-3xl mx-auto">
            ...
            <button className="px-8 py-3 bg-gradient-to-r from-[#d4af37] to-[#f4d03f] text-black font-semibold rounded-lg hover:shadow-xl hover:shadow-[#d4af37]/30 transition-all duration-300">
