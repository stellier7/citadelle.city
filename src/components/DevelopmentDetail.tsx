    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/developments" className="text-[#d4af37] hover:underline">
      ...
      <div className="relative h-96 bg-zinc-900">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="px-4 py-1 rounded-full text-sm font-semibold bg-[#d4af37]/20 text-[#d4af37]">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                ...
                <div className="text-2xl font-bold text-[#d4af37]">{project.targetAnnualReturn}%</div>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                        ...
                        <span className="text-[#d4af37] font-bold text-lg">{formatCurrency(project.tokenizedRaise)}</span>
                      </div>
                      <div className="flex justify-between items-center py-3 border-b border-zinc-800">
                  ...
                  <div>
                    ...
                    <div className="bg-black/50 rounded-lg p-6">
                      <div className="text-center mb-6">
                        <div className="text-5xl font-bold text-[#d4af37] mb-2">{project.targetAnnualReturn}%</div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-black/50 rounded-lg p-4 flex items-center justify-between">
                      ...
                      <button className="text-[#d4af37] hover:text-[#f4d03f] font-semibold">Download</button>
                    </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-black border border-zinc-700 rounded-lg px-4 pl-8 py-3 text-white text-lg focus:outline-none focus:border-[#d4af37]"
                  />
                </div>
              ...
              <div className="space-y-4 mb-6 pb-6 border-b border-zinc-800">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[#d4af37] font-bold">{formatCurrency(estimatedAnnualYield)}</span>
                </div>
              </div>

              {/* Tier Badge */}
              {tier && (
                <div className={`mb-6 ${getTierInfo(tier)?.bg} border border-${tier === 'founder' ? '[#d4af37]' : 'current'} rounded-lg p-4`}>
              ...
              {/* CTA Button */}
              <button className="w-full py-4 bg-gradient-to-r from-[#d4af37] to-[#f4d03f] text-black font-bold rounded-lg hover:shadow-xl hover:shadow-[#d4af37]/50 transition-all duration-300 mb-4">
                Reserve Your Tokens
              </button>
